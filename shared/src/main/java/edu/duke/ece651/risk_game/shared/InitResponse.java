...
public class InitResponse extends Response {
     ...
     */
    public InitResponse(Integer playerID, String playerName, Integer gameState, List<Territory> territories, Integer unitAvailable) {
        super(playerID, playerName, gameState, territories);
